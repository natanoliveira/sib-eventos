import { PrismaClient, UserRole, UserStatus, EventStatus, RegistrationStatus, TicketStatus, PaymentMethod, PaymentStatus, InstallmentStatus, InvoiceStatus, MemberCategory } from '@prisma/client';
  ...
  const persons = await Promise.all([
    prisma.person.create({
      data: {
        ...
        category: MemberCategory.MEMBRO_ATIVO,
        status: UserStatus.ACTIVE,
    ...
    prisma.person.create({
      data: {
        ...
        category: MemberCategory.MEMBRO_VISITANTE,
        status: UserStatus.ACTIVE,
    ...
    prisma.person.create({
      data: {
        ...
        category: MemberCategory.MEMBRO_NOVO,
        status: UserStatus.ACTIVE,
